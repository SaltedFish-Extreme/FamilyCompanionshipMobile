package com.hisense.sound.widget.view;
 ...
 * desc：幕布遮挡View
 */
public class GuiderView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
...
// 背景画笔
        ...
        if (backgroundColor != 0) {
            ...
            bgPaint.setColor(getResources().getColor(com.drake.net.R.color.cardview_shadow_end_color));
        }
// 绘制屏幕背景
